...
La classe Variation1 modélise la variation d'une fonction scalaire en
...
\end{verbatim}
\begin{tableFonctionsFixe}{Variation1 : méthodes publiques}
...
spécifiques}\label{sec:Variation1-conseils} Cette classe est
...
table~\ref{tab:Variation1-att-priv}, il n'y a pas d'attribut protégé.
\begin{tableAttributsFixe}{attributs privés de la classe Variation1}
