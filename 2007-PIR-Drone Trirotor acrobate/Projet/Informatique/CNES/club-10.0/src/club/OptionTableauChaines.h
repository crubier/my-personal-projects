...
//
//$Resume
//       fichier d'en-tête de la classe OptionTableauChaines
//
//$Description
...
//
//$Resume
//       classe des options prenant des arguments chaînes de caractères
//
//$Description
//       gestion d'une option de la ligne de commande à arguments
//       chaînes de caractères. Cette classe dérive de OptionBase.
//
//$Usage
//>     construction : 
