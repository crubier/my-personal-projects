...
use int_mslib_mvi_car_equa_ellip
use int_mslib_mvi_car_equa_hyperb
use int_mslib_mvi_car_equa_parab
...
intrinsic epsilon, present, dot_product, huge

character(len=pm_longueur_info_utilisateur) :: info_utilisateur = &
                     '@(#) Fichier MSLIB mv_car_equa.f90: derniere modification V4.1 >'

! Ne pas toucher a la ligne suivante
character(len=pm_longueur_rcs_id) :: rcs_id =' $Id: mv_car_equa.f90,v 1.10 2003/10/14 12:54:08 mslibdev Exp $ '
...
rscal = dot_product(pos_car, vit_car)           ! produit scalaire position*vitesse
