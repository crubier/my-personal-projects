...
integer              :: nm                           ! nombre de jour du mois precedent.
integer              :: num
integer              :: nb_jour, nb_mois             ! variables intermediaires du calcul des sorties jour et mois
type(tm_jour_sec)    :: joursec_norme                ! jour julien norme 
type(tm_code_retour) :: code_retour_local
real(pm_reel)        :: heure_decimale, min_decimale ! heure et minutes en valeurs decimales
...
character(len=pm_longueur_info_utilisateur) :: info_utilisateur = &
                     '@(#) Fichier MSLIB md_julien_calend.f90: derniere modification V4.1 >'

! Ne pas toucher a la ligne suivante
character(len=pm_longueur_rcs_id) :: rcs_id =' $Id: md_julien_calend.f90,v 1.7 2003/10/14 12:46:32 mslibdev Exp $ '
