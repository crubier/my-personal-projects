...
include 'arg_mri_equa_V_eclip_M.h'
...
character(len=pm_longueur_info_utilisateur) :: info_utilisateur = &
                     '@(#) Fichier MSLIB mri_equa_V_eclip_M.f90: derniere modification V4.1 >'

! Ne pas toucher a la ligne suivante
character(len=pm_longueur_rcs_id) :: rcs_id =' $Id: mri_equa_V_eclip_M.f90,v 1.8 2003/10/14 12:50:51 mslibdev Exp $ '
