...
intrinsic epsilon, sqrt, sin, dot_product, matmul


character(len=pm_longueur_info_utilisateur) :: info_utilisateur = &
     '@(#) Fichier MSLIB mv_car_cir.f90: derniere modification V4.1 >'

! Ne pas toucher a la ligne suivante
character(len=pm_longueur_rcs_id) :: rcs_id =' $Id: mv_car_cir.f90,v 1.8 2003/10/14 12:53:58 mslibdev Exp $ '
...
srrp = dot_product(pos_car, vit_car)!     produit scalaire position.vitesse
