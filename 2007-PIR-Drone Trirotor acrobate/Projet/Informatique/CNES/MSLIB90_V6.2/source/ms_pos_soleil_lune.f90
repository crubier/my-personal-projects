...
character(len=pm_longueur_info_utilisateur) :: info_utilisateur = &
                     '@(#) Fichier MSLIB ms_pos_soleil_lune.f90: derniere modification V6.1 >'

! Ne pas toucher a la ligne suivante
character(len=pm_longueur_rcs_id) :: rcs_id =' $Id: ms_pos_soleil_lune.f90,v 1.2 2004/10/14 09:02:14 mslibatv Exp $ '
