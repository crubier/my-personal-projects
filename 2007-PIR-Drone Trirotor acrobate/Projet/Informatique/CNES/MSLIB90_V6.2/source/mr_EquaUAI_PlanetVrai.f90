...
character(len=pm_longueur_info_utilisateur) :: info_utilisateur = &
                     '@(#) Fichier MSLIB mr_EquaUAI_PlanetVrai.f90: derniere modification V5.0 >'

! Ne pas toucher a la ligne suivante
character(len=pm_longueur_rcs_id) :: rcs_id =' $Id: mr_EquaUAI_PlanetVrai.f90,v 1.6 2003/12/15 17:35:28 mslibdev Exp $ '
