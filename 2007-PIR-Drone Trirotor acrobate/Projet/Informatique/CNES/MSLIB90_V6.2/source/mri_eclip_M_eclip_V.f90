...
character(len=pm_longueur_info_utilisateur) :: info_utilisateur = &
                     '@(#) Fichier MSLIB mri_eclip_M_eclip_V.f90: derniere modification V4.1 >'

intrinsic matmul, cos, sin

! Ne pas toucher a la ligne suivante
character(len=pm_longueur_rcs_id) :: rcs_id =' $Id: mri_eclip_M_eclip_V.f90,v 1.8 2003/10/14 12:49:55 mslibdev Exp $ '
