...
//
//$Resume
//       fichier d'en-tête de la classe FamilleProlongementZero
//
//$Description
...
//>       class FamilleProlongementZero
//$Resume
//       modèle géométrique d'attitude (cas particuler d'alignement)
//
//$Description
//       Cette classe implante un modèle d'attitude à un degré de
//       liberté tel que theta rencontre 0 et que Mu1=Gamma=Pi/2
//
//$Usage
//>     construction : 
