...
Correcteur.Attitude.Vecteur.Kp=0.0001;
Correcteur.Attitude.Vecteur.Ki=0;
Correcteur.Attitude.Vecteur.Kd=0;
Correcteur.Attitude.Vecteur.Kdd=0;
Correcteur.Attitude.Quaternion.Kp=0.2;
Correcteur.Attitude.Quaternion.Ki=0;
Correcteur.Attitude.Quaternion.Kd=10;
Correcteur.Attitude.Quaternion.Kdd=1;
Correcteur.Position.Kp=50;
Correcteur.Position.Ki=0;
Correcteur.Position.Kd=0.8;
Correcteur.Position.Kdd=0.1;
...
Mecanique.Bras.Inertie=[0.002 0 0;0 0.003 0;0 0 0.003];
Mecanique.Bras.CFrot=0.01;
Mecanique.Bras.Csat=0.1;
Mecanique.Corps.Masse=0.4;
Mecanique.Corps.Inertie=[0.004 0 0; 0 0.004 0;0 0 0.004];
Mecanique.Rotor.T=0.2;
Mecanique.Rotor.Fsat=10;
