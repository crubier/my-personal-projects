...
real(pm_reel)    :: Rphi, fonc, dfonc, alpha            !     rayon, fonction et derivee pour
                                                        !     Newton et coefficient alpha qui intervient dans le calcul de fonc 
                                                        !     et dfonc
real(pm_reel)    :: exc2         !  carre de l'excentricite i.e. 2*aplat - aplat**2
...
logical ::   oknewt                   !     variables de travail servant a verfier si la solution fournie par Newton
                                      !     est correcte ou pas
real(pm_reel):: K,KRphiplusH, RphiplusH, correc  !     variables de calcul pour la jacobienne
...
character(len=pm_longueur_info_utilisateur) :: info_utilisateur = &
                     '@(#) Fichier MSLIB mt_car_geod.f90: derniere modification V4.1 >'

! Ne pas toucher a la ligne suivante
character(len=pm_longueur_rcs_id) :: rcs_id =' $Id: mt_car_geod.f90,v 1.11 2003/10/14 12:52:23 mslibdev Exp $ '
