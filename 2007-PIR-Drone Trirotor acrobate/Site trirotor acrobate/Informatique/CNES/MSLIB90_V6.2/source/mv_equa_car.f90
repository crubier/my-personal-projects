...
! Modules
! =======
use int_mslib_mvi_equa_car_ellip
use int_mslib_mvi_equa_car_hyperb
use int_mslib_mvi_equa_car_parab
...
character(len=pm_longueur_info_utilisateur) :: info_utilisateur = &
                     '@(#) Fichier MSLIB mv_equa_car.f90: derniere modification V4.1 >'

! Ne pas toucher a la ligne suivante
character(len=pm_longueur_rcs_id) :: rcs_id =' $Id: mv_equa_car.f90,v 1.7 2003/10/14 12:54:28 mslibdev Exp $ '
