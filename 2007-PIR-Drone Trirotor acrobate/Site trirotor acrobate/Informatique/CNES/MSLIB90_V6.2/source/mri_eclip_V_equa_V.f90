...
include 'arg_mri_eclip_V_equa_V.h'
...
character(len=pm_longueur_info_utilisateur) :: info_utilisateur = &
                     '@(#) Fichier MSLIB mri_eclip_V_equa_V.f90: derniere modification V4.1 >'

intrinsic sin, cos, matmul

! Ne pas toucher a la ligne suivante
character(len=pm_longueur_rcs_id) :: rcs_id =' $Id: mri_eclip_V_equa_V.f90,v 1.8 2003/10/14 12:50:21 mslibdev Exp $ '
