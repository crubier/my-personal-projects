...
intrinsic  asin, sqrt, dot_product, epsilon

character(len=pm_longueur_info_utilisateur) :: info_utilisateur = &
                     '@(#) Fichier MSLIB mt_car_geoc.f90: derniere modification V4.1 >'

! Ne pas toucher a la ligne suivante
character(len=pm_longueur_rcs_id) :: rcs_id =' $Id: mt_car_geoc.f90,v 1.12 2003/10/14 12:52:18 mslibdev Exp $ '
