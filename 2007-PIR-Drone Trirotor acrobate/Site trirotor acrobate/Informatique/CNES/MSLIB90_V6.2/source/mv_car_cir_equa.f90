...
intrinsic epsilon, dot_product, sqrt, matmul


character(len=pm_longueur_info_utilisateur) :: info_utilisateur = &
                     '@(#) Fichier MSLIB mv_car_cir_equa.f90: derniere modification V4.1 >'

! Ne pas toucher a la ligne suivante
character(len=pm_longueur_rcs_id) :: rcs_id =' $Id: mv_car_cir_equa.f90,v 1.8 2003/10/14 12:54:03 mslibdev Exp $ '
...
scal = dot_product(pos_car, vit_car)
