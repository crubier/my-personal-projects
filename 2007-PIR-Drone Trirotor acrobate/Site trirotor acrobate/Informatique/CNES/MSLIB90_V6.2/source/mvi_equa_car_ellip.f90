...
character(len=pm_longueur_info_utilisateur) :: info_utilisateur = &
                     '@(#) Fichier MSLIB mvi_equa_car_ellip.f90: derniere modification V4.1 >'

! Ne pas toucher a la ligne suivante
character(len=pm_longueur_rcs_id) :: rcs_id =' $Id: mvi_equa_car_ellip.f90,v 1.8 2003/10/14 12:55:29 mslibdev Exp $ '
