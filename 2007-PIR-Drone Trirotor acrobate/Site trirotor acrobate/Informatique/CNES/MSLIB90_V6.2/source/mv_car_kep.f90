...
use int_mslib_mvi_car_kep_ellip
use int_mslib_mvi_car_kep_hyperb
use int_mslib_mvi_car_kep_parab
...
intrinsic abs, sqrt, epsilon, dot_product

character(len=pm_longueur_info_utilisateur) :: info_utilisateur = &
     '@(#) Fichier MSLIB mv_car_kep.f90: derniere modification V4.1 >'

! Ne pas toucher a la ligne suivante
character(len=pm_longueur_rcs_id) :: rcs_id =' $Id: mv_car_kep.f90,v 1.10 2003/10/14 12:54:13 mslibdev Exp $ '
...
pos_fois_vit = dot_product(pos_car,vit_car)                      ! produit scalaire position*vitesse
