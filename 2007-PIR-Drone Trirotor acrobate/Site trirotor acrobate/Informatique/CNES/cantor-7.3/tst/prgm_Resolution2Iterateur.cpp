...
//
//$Historique
//       $Log: prgm_Resolution2Iterateur.cpp,v $
...
//
//$Version
//       $Id: prgm_Resolution2Iterateur.cpp,v 1.7 2000/10/24 16:26:42 cantor Exp $
//$Auteur
//        P-A.Cros  CSSI
//        M. Julien CSSI 
//$<>
...
static ValeurDerivee2 SinusCroissant (double t, void* d)
{ *((int *) d) += 1;
...
{ ClubAllocHandler h; // utilise uniquement pour ses constructeur/destructeur
  ...
  try
  {
    ...
    compteurAppels = 0;
    Resolution2Iterateur iter (SinusCroissant, (void *) &compteurAppels,
                               a, b, n, seuil, seuil);
