...
//
//$Version
//       $Id: prgm_ValeurDerivee2.cpp,v 1.7 2000/10/24 16:26:42 cantor Exp $
//$Auteur
//        P-A.Cros  CSSI
//        M. Julien CSSI 
//$<>
...
{ // fonction utilisant tous les operateurs de ValeurDerivee2
...
template ValeurDerivee2 fonctionCompliquee (const ValeurDerivee2& x);
...
{ ClubAllocHandler hdl; // utilise uniquement pour ses constructeur/destructeur
  ...
  try
  {
    ...
    ValeurDerivee2 x (2.0, 1.0);

    ValeurDerivee2 f  = 2.0 * sin (x * (1.0 + x) + 1.0);
    cout << "f(x) = " << f << '\n';

    f = ValeurDerivee2 (3.0, 1.0);
    cout << "f(x) = " << f << '\n';

    ValeurDerivee2 g = 2.9;
    cout << "g(x) = " << g << '\n';
    ...
    cout << "\n  valeur     taylor     ecart\n";
    ValeurDerivee2 x0 (1.0, 1.0);
    ValeurDerivee2 y0 = fonctionCompliquee (x0);
