 ...
 * TableModelXML
 */
public class TableModelXML extends AbstractTableModel implements Serializable {
...
//
     ...
     */
    public TableModelXML() {
        this(0, 0);
    }
	
	public TableModelXML(ArbreXMLNode node) {
        this(0, 2);
		List<Attribute> attributs = node.getElement().getAttributes();
		Vector<String> NomsColonnes = new Vector<String>();
		NomsColonnes.add("Attribut");
		NomsColonnes.add("Valeur");
		this.setColumnIdentifiers(NomsColonnes);
		for(Attribute attr : attributs) {
			Vector<String> ContenuLigne = new Vector<String>();
			ContenuLigne.add(attr.getName());
			ContenuLigne.add(attr.getValue());
			this.addRow(ContenuLigne);
		}
		this.setNode(node);
    }

	public ArbreXMLNode getNode() {
		return node;
	}

	public void setNode(ArbreXMLNode node) {
		this.node = node;
	}
     ...
     * @see #setValueAt
     */
    public TableModelXML(int rowCount, int columnCount) {
     ...
     * @see #setValueAt
     */
    public TableModelXML(Vector columnNames, int rowCount) {
     ...
     * @see #setValueAt
     */
    public TableModelXML(Object[] columnNames, int rowCount) {
     ...
     * @see #setDataVector
     */
    public TableModelXML(Vector data, Vector columnNames) {
     ...
     * @see #setDataVector
     */
    public TableModelXML(Object[][] data, Object[] columnNames) {
        setDataVector(data, columnNames);
    }
